...
API_URL="https://api.github.com/repos/Configuracao/ThemeX-UI/contents/themes"
...
select theme in "${themes[@]}"; do
    if [ -n "$theme" ]; then
        ...
        FILE_URL="https://raw.githubusercontent.com/Configuracao/ThemeX-UI/main/themes/$theme"
        TEMP_FILE="/tmp/$theme"
